...
main = tkinter.Tk()
main.title("Biometric Information Recognization Using Artificial Intellegence Algorithm:A Performance Comparision ")
...
def GUI():
    ...
    font = ('times', 16, 'bold')
    title = Label(main, text='Biometric Information Recognization Using Artificial Intellegence Algorithm:A Performance Comparision ')
